...
def main():
    ...
    our_shader = Shader("./02_shader.vs", "./02_shader.fs")
    ...
    glVertexArrayVertexBuffer(vao, 0, vbo, 0, 8 * vertices.itemsize)
    ...
    glVertexArrayAttribFormat(vao, 2, 2, GL_FLOAT, GL_FALSE, 6 * vertices.itemsize)
