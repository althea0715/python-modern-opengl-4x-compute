...
def main():
    ...
    lighting_shader = Shader("./01_colors.vs", "./01_colors.fs")
    ...
    glVertexArrayVertexBuffer(cube_vao, 0, vbo, 0, 3 * vertices.itemsize)
    ...
    glVertexArrayAttribFormat(cube_vao, 1, 2, GL_FLOAT, GL_FALSE, 3 * vertices.itemsize)
    ...
    glVertexArrayVertexBuffer(light_cube_vao, 0, vbo, 0, 3 * vertices.itemsize)
