...
def main():
    ...
    lighting_shader = Shader("./04_light_casters.vs", "./04_light_casters.fs")
    ...
    while not glfwWindowShouldClose(window):
        ...
        lighting_shader.set_float("light.cutOff", glm.cos(glm.radians(12.5)))
        lighting_shader.set_float("light.outerCutOff", glm.cos(glm.radians(17.5)))
